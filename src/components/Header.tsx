...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-primary text-white shadow-md transition-shadow">
            ...
            {!userLoading ? (
              user ? (
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-64 p-2 rounded-xl mt-2 animate-in zoom-in-95 duration-200" align="end">
