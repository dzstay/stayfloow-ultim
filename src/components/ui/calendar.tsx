    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "h-7 w-7 bg-white p-0 opacity-100 hover:opacity-100 absolute left-8 z-20 border border-slate-200 shadow-sm rounded-full"
        ),
        button_next: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 bg-white p-0 opacity-100 hover:opacity-100 absolute right-8 z-20 border border-slate-200 shadow-sm rounded-full"
        ),
