...
export const localeDetails: Record<Locale, { name: string; flag: string; dir: 'ltr' | 'rtl' }> = {
...
export const translations: Record<string, Record<Locale, string>> = {
    ...
    "popular_amenities": { fr: "Équipements populaires", en: "Popular amenities", ar: "المرافق الشائعة", es: "Instalaciones populaires" },
    ...
    "contact.email": { fr: "Email", en: "Email", ar: "البريد electrónico", es: "Correo electrónico" },
